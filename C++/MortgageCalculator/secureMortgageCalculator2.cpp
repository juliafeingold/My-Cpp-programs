...
int getPassword()
{ 
  int count = 0;//count how many times the user enter the password
  while (count !=3)
  {
    string password;
...
{
  //Data
  int count;//count how many times the user enter the password
  int years = 30;
  ...
  count = getPassword();//programmer defined functions
