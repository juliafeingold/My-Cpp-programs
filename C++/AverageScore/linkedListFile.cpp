...
int main()
{
  ...
  Score* p; //list pointer points to the current node used for traversing the list
  Score* next; //
  ...
  int maxValue;//the highest score
  int minValue;// the lowest value
  ...
  // traverse the list and find the average 
  ...
  //   if(minValue > p->value) minValue = p->value;
