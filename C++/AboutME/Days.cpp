...
{
  //Data
  int myAge = 22; //the number of years in which I lived, including my birth year and the current year
  ...
  // introduction
  cout << "Objective: calculate how many days old I will be by the due date of this assigment.\n"; 
