...
int main()
{
  ...
  int e;//looking for not valid email character after @
...
//test valid email character

  
//not valid email character
}//main
...
//check is email address character is valid or not, true if valid, false if not valid 
